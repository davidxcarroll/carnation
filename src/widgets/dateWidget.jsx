...
const DateWidget = () => {
  ...
  return (
    <div className="row-span-3 p-[3vw] leading-9 flex flex-col items-center justify-between bg-blue-600 text-cyan-200 text-center">
      <div className="">Today is</div>
      <div className="">{dateParts.weekday}</div>
      <div className="text-[clamp(3em,12vw,40em)] leading-[clamp(.8em,8vw,30em)]">{dateParts.day}</div>
